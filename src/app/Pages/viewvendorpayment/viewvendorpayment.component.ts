...
@Component({
  selector: 'app-viewvendorpayment',
  templateUrl: './viewvendorpayment.component.html',
  styleUrls: ['./viewvendorpayment.component.css']
})
export class ViewvendorpaymentComponent implements OnInit {
